    ...
    let ImageContainer = (props)=>{        
       return(
        ...
        <div style={
          ...
          <img className={"imagess"} src={props.src}  />  
       ...
       return(
           <div>
               {images.map((imagenes)=>{
                   return(
                    // <img src={imagenes.source} />  
                    <ImageContainer src={imagenes.source} />
                   )                    
               })}
            </div>   
       )   
}
export default EjemploDeIteraciones4;